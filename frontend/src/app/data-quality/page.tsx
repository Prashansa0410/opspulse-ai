      ...
      {report && (
        <div className="p-6 rounded-2xl border border-emerald-800/80 bg-emerald-950/20 grid grid-cols-1 sm:grid-cols-4 gap-4 items-center shadow-lg">
          ...
          <div className="p-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs font-mono">
            <span className="text-slate-400">Rules Passed</span>
          ...
          <div className="p-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs font-mono">
            <span className="text-slate-400">Critical / Warnings</span>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {report.rules_results.map((rule) => (
              <div
                key={rule.rule_id}
                className="p-4 rounded-xl border border-slate-800 bg-[#111827]/90 space-y-2 hover:border-slate-700 transition-colors"
              >
                ...
                <div className="flex flex-wrap items-center gap-4 text-[11px] font-mono text-slate-400 pt-2 border-t border-slate-800/80">
                  <span>Target Table: <strong className="text-slate-200">{rule.table_name}</strong></span>
                  <span>Records Audited: <strong className="text-slate-200">{rule.records_checked.toLocaleString()}</strong></span>
