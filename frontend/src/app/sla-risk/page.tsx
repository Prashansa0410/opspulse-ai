      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-5 rounded-xl border border-slate-800 bg-[#111827]/90 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-white font-mono">Model Validation Metrics</h3>
          </div>

          <div className="grid grid-cols-2 gap-3 text-xs font-mono">
            <div className="p-3 rounded-lg bg-slate-900/90 border border-slate-800">
              <span className="text-slate-400 text-[10px]">ROC-AUC Score</span>
        ...
        <div className="lg:col-span-2 p-5 rounded-xl border border-slate-800 bg-[#111827]/90 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-white font-mono">Top Feature Importances (Attribution Weights)</h3>
            </div>
            <span className="text-xs text-slate-400 font-mono">Gradient Boosting Tree</span>
          </div>
          ...
          <div className="space-y-2.5">
            {Object.entries(importances).length > 0 ? (
                ...
                return (
                  <div key={idx} className="space-y-1">
                    <div className="flex justify-between text-xs font-mono">
                      <span className="text-slate-300">{feat.replace(/_/g, " ")}</span>
              ...
              <div className="space-y-2 text-xs font-mono">
                ...
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-blue-500 h-full w-[68%]"></div></div>

                <div className="flex justify-between text-slate-300">
                  <span>Warehouse Packing Hours</span>
                  <span className="text-blue-400 font-bold">28%</span>
                </div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-blue-500 h-full w-[56%]"></div></div>

                <div className="flex justify-between text-slate-300">
                  <span>Carrier Dock Pickup Delay</span>
                  <span className="text-blue-400 font-bold">22%</span>
                </div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-blue-500 h-full w-[44%]"></div></div>
              </div>
            )}
          </div>
        </div>
                    ...
                    return (
                      <tr key={s.shipment_id} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="py-3 px-4">
                          <div className="font-medium text-slate-200">{s.carrier}</div>
                          <div className="text-[11px] text-slate-400 font-mono">{s.route}</div>
                        </td>
                        ...
                        <td className="py-3 px-4 text-slate-300 text-xs">
                          {s.top_factors && s.top_factors[0] ? (
                            ...
                            <span className="text-slate-400">Normal Parameters</span>
                          )}
                        </td>
                      </tr>
                    );
