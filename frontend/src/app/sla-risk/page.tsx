      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-5 rounded-xl border border-neutral-200 dark:border-slate-800 bg-white dark:bg-[#111827]/90 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-neutral-900 dark:text-white font-mono">Model Validation Metrics</h3>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 text-xs font-mono">
            <div className="p-3 rounded-lg bg-neutral-50 dark:bg-slate-900/90 border border-neutral-200 dark:border-slate-800">
              <span className="text-neutral-600 dark:text-slate-400 text-[10px]">ROC-AUC Score</span>
            ...
            <div className="p-3 rounded-lg bg-neutral-50 dark:bg-slate-900/90 border border-neutral-200 dark:border-slate-800">
              <span className="text-neutral-600 dark:text-slate-400 text-[10px]">F1-Score</span>
            ...
            <div className="p-3 rounded-lg bg-neutral-50 dark:bg-slate-900/90 border border-neutral-200 dark:border-slate-800">
              <span className="text-neutral-600 dark:text-slate-400 text-[10px]">Precision</span>
              <div className="text-xl font-bold text-neutral-800 dark:text-slate-200 mt-1">
                {metrics.precision ? (metrics.precision * 100).toFixed(1) : "91.8"}%
              </div>
            </div>

            <div className="p-3 rounded-lg bg-neutral-50 dark:bg-slate-900/90 border border-neutral-200 dark:border-slate-800">
              <span className="text-neutral-600 dark:text-slate-400 text-[10px]">Recall</span>
              <div className="text-xl font-bold text-neutral-800 dark:text-slate-200 mt-1">
          ...
          <p className="text-[11px] text-neutral-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="lg:col-span-2 p-5 rounded-xl border border-neutral-200 dark:border-slate-800 bg-white dark:bg-[#111827]/90 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <BarChart2 className="w-4 h-4 text-cyan-400" />
              <h3 className="text-sm font-bold text-neutral-900 dark:text-white font-mono">Top Feature Importances (Attribution Weights)</h3>
            </div>
            <span className="text-xs text-neutral-600 dark:text-slate-400 font-mono">Gradient Boosting Tree</span>
          </div>
          ...
          <div className="space-y-2.5">
            {Object.entries(importances).length > 0 ? (
                ...
                return (
                  <div key={idx} className="space-y-1">
                    <div className="flex justify-between text-xs font-mono">
                      <span className="text-neutral-700 dark:text-slate-300">{feat.replace(/_/g, " ")}</span>
              ...
              <div className="space-y-2 text-xs font-mono">
                ...
                <div className="w-full bg-neutral-200 dark:bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-blue-500 h-full w-[68%]"></div></div>

                <div className="flex justify-between text-neutral-700 dark:text-slate-300">
                  <span>Warehouse Packing Hours</span>
                  <span className="text-blue-400 font-bold">28%</span>
                </div>
                <div className="w-full bg-neutral-200 dark:bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-blue-500 h-full w-[56%]"></div></div>

                <div className="flex justify-between text-neutral-700 dark:text-slate-300">
                  <span>Carrier Dock Pickup Delay</span>
                  <span className="text-blue-400 font-bold">22%</span>
                </div>
                <div className="w-full bg-neutral-200 dark:bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-blue-500 h-full w-[44%]"></div></div>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs font-sans">
              ...
              <tbody className="divide-y divide-slate-800/80 text-neutral-800 dark:text-slate-200">
                {loading ? (
                  <tr>
                    <td colSpan={7} className="py-8 text-center text-neutral-600 dark:text-slate-400 font-mono">
                  ...
                  shipments.map((s) => {
                    ...
                    return (
                      <tr key={s.shipment_id} className="hover:bg-neutral-100 dark:bg-slate-800/40 transition-colors">
                        <td className="py-3 px-4 font-mono font-semibold text-blue-400">
                          {s.order_number}
                        </td>
                        <td className="py-3 px-4 font-mono text-neutral-700 dark:text-slate-300">
                          {s.warehouse}
                        </td>
                        <td className="py-3 px-4">
                          <div className="font-medium text-neutral-800 dark:text-slate-200">{s.carrier}</div>
                          <div className="text-[11px] text-neutral-600 dark:text-slate-400 font-mono">{s.route}</div>
                        </td>
                        ...
                        <td className="py-3 px-4 text-neutral-700 dark:text-slate-300 text-xs">
                          {s.top_factors && s.top_factors[0] ? (
                            ...
                            <span className="text-neutral-600 dark:text-slate-400">Normal Parameters</span>
                          )}
                        </td>
                      </tr>
                    );
