        ...
        <div className="p-4 rounded-xl border border-neutral-200 dark:border-slate-800 bg-white dark:bg-[#111827]/90 space-y-3 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs font-mono">
            ...
            <div className="p-2 rounded bg-rose-950/40 border border-rose-900/60">
              ...
              <div className="text-base font-bold text-rose-400 mt-0.5">BLR-01 (94.6%)</div>
            </div>
            <div className="p-2 rounded bg-amber-950/40 border border-amber-900/60">
              <span className="text-amber-300">Pickup Backlog</span>
              <div className="text-base font-bold text-amber-400 mt-0.5">SwiftExpress</div>
            </div>
          </div>
        </div>
